...
import com.gof.dao.MemberRepository;
...
@Setter
@Slf4j
public class MstCoaBean implements Serializable{

	@Inject
	private FacesContext faceCtx;
	
    @Inject
    private MstDao mstDaoo;
    
    private List<MstCoa> mstCoaList ;
    private List<MstCoa> filteredList ;
    private MstCoa selected;
    
    @PostConstruct
    public void initNewMember() {
    	mstCoaList = mstDaoo.getMstCoaList();
    	log.info("MstCoaBean Context : {},{}", faceCtx.getViewRoot().getViewId());
    }
...
//	}
//
//	public void setMstCoaList(List<MstCoa> mstCoaList) {
//		this.mstCoaList = mstCoaList;
//	}
//
//	public List<MstCoa> getFilteredMstCoaList() {
//		return filteredMstCoaList;
//	}
//
//	public void setFilteredMstCoaList(List<MstCoa> filteredMstCoaList) {
//		this.filteredMstCoaList = filteredMstCoaList;
//	}
//	
//
//	 public MstCoa getSelected() {
//		return selected;
//	}
//
//	public void setSelected(MstCoa selected) {
